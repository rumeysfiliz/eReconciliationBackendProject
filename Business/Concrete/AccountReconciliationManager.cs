...
namespace Business.Concrete
{
    public class AccountReconciliationManager : IAccountReconciliationService
    {
        ...
        //[SecuredOperation("AccountReconciliation.Add,Admin")]
        //[CacheRemoveAspect("IAccountReconciliationService.Get")]
        [TransactionScopeAspect] //Bu işlemde hata olursa bu işlemi iptal etsin komple  
        ...
        public IResult SendReconciliationMail(AccountReconciliationDto accountReconciliationDto)
        {
            ...
            string link = "http://localhost:7020/api/AccountReconciliations/GetByCode?code=" + accountReconciliationDto.Guid;
        ...
        [PerformanceAspect(3)]
        [SecuredOperation("AccountReconciliation.Update,Admin")]// tamam mıdır = son vir şey daha gösterebilir miyima AAA oldu çok teşekkür ederim :) kolay gelsin iyi eğitimler
        [CacheRemoveAspect("IAccountReconciliationService.Get")]
