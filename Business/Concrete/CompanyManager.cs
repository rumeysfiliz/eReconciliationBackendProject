...
namespace Business.Concrete
{
    ...
    {
        //Ef yerine I yı çağırarak Dependeceny Injection gerçekleştirdik yani EntityFramework e bağlı iken soyu bağımlılık oldu spyut olduğu için somut bağımlılk gidecek.
        private readonly ICompanyDal _companyDal;
        public CompanyManager(ICompanyDal companyDal) //Interfacesler newlenemediği için newleme işlemi yapıyor.
        {
