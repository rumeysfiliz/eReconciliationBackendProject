...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowOrigin",
        builder => builder.WithOrigins("https://localhost:7020", "http://localhost:4200"));
});
...
app.UseCors(builder => builder.WithOrigins("https://localhost:7020", "http://localhost:4200").AllowAnyHeader());
